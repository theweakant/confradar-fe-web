...
interface CollaboratorDetailProps {
  collaborator: UserProfileResponse;
  onClose: () => void;
}
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-900">{getRoleLabel(collaborator.role)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-900">{getStatusLabel(collaborator.status)}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-900">{formatDate(collaborator.joinedDate)}</p>
            </div>
          </div>
        </div>
      </div>
