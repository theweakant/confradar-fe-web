...
const ResearchDocumentsTab: React.FC<ResearchDocumentsTabProps> = ({
    ...
    return (
        <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Tài liệu & Hướng dẫn</h2>
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-4">
                        {conference.materialDownloads.map((material) => (
                            <div key={material.materialDownloadId} className="bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-5 hover:from-gray-100 hover:to-gray-150 hover:border-gray-300 transition-all">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {material.fileUrl && (
                                            <a
                                                ...
                                                className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 hover:bg-green-200 text-green-700 rounded-lg text-sm font-medium transition-all"
                                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {conference.rankingFileUrls.map((file, index) => (
                            <div
                                ...
                                className="bg-gray-50 border border-gray-200 rounded-lg p-5 hover:bg-gray-100 hover:border-gray-300 transition-all"
                            >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {reference.referenceUrl && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-purple-600 hover:text-purple-700 text-sm break-all transition-colors"
                                            >
                                                {reference.referenceUrl}
                                            </a>
                                        )}
