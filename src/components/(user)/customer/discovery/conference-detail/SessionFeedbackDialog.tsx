...
const SessionFeedbackDialog: React.FC<SessionFeedbackDialogProps> = ({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto bg-white text-gray-900 border-gray-200">
                <DialogHeader>
                ...
                <div className="space-y-6">
                    ...
                    {canSubmitFeedback && (
                        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                            <h3 className="text-lg font-semibold mb-4 text-gray-900">Thêm đánh giá của bạn</h3>
