...
export default function AdminDashboard() {
  ...
  const recentActivities = [
    { user: "Nguyễn Văn A", action: "đã tạo hội nghị mới", time: "5 phút trước" },
  ...
  const getStatusColor = (status: string) => {
    switch(status) {
      case "Đang xử lý": return "text-blue-600 bg-blue-50";
      case "Chờ duyệt": return "text-yellow-600 bg-yellow-50";
      case "Đã giải quyết": return "text-green-600 bg-green-50";
      default: return "text-gray-600 bg-gray-50";
    }
  };
