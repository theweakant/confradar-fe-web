  ...
  return (
    <div className="relative" id={id}>
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-2 bg-white text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all shadow-sm"
      >
        ...
        <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-xl z-10 max-h-60 overflow-y-auto">
          {options.map((option) => (
            <button
              ...
              className={`w-full text-left px-4 py-2 text-sm text-gray-900 hover:bg-gray-100 transition-colors ${option.value === value ? "bg-gray-100" : ""
                }`}
            >
              {option.label}
            </button>
