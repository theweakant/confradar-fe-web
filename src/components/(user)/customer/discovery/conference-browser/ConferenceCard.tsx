  ...
  return (
    <div
      ...
      className="group relative bg-white rounded-xl border border-gray-200 overflow-hidden
        ...
        hover:scale-[1.03] hover:border-blue-500 hover:shadow-[0_12px_30px_rgba(59,130,246,0.25)]"
    >
      ...
      <div className="p-4">
        ...
        <div className="text-xs text-gray-700 mb-2 font-medium">Giá: {displayPrice}</div>
