...
const handleAddRefundPolicy = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Tạo hội thảo nghiên cứu mới</h1>
        <p className="text-gray-600 mt-1">Điền đầy đủ thông tin để tạo hội thảo nghiên cứu</p>
      </div>
    ...
    <div>
      ...
      {newRefundPolicy.refundDeadline && basicForm.ticketSaleStart && basicForm.ticketSaleEnd && (
        <div className="mt-1 text-xs">
          ...
          {/* STEP 7: MATERIALS & RANKINGS */}
          <div className="bg-white border rounded-lg p-6 mb-6">
            <h3 className="text-lg font-semibold mb-4">6. Tài liệu & Xếp hạng (Tùy chọn)</h3>
            
            {/* Research Materials */}
            <div className="border p-4 rounded mb-4">
              <h4 className="font-medium mb-3">📚 Tài liệu nghiên cứu ({researchMaterials.length})</h4>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  {researchMaterials.map((m, idx) => (
                    <div key={idx} className="p-3 bg-gray-50 rounded border border-gray-200">
                      ...
                      {m.fileDescription && (
                        <div className="text-xs text-gray-600 mt-1">{m.fileDescription}</div>
                      )}
                      {m.file && (
            ...
            {/* Ranking Files */}
            <div className="border p-4 rounded mb-4">
              <h4 className="font-medium mb-3">🏆 File xếp hạng ({rankingFiles.length})</h4>
                  ...
                  {rankingFiles.map((rf, idx) => (
                    <div key={idx} className="p-3 bg-gray-50 rounded flex justify-between items-center">
                      <div className="text-sm break-all">
                        {rf.fileUrl || (rf.file instanceof File ? rf.file.name : "File uploaded")}
                      </div>
                      <Button
                        size="sm"
                        variant="destructive"
            ...
            {/* Ranking References */}
            <div className="border p-4 rounded">
              <h4 className="font-medium mb-3">🔗 Tham khảo xếp hạng ({rankingReferences.length})</h4>
          ...
          <div className="bg-white border rounded-lg p-6 mb-6">
            <h3 className="text-lg font-semibold mb-4">8. Nhà tài trợ (Tùy chọn)</h3>
