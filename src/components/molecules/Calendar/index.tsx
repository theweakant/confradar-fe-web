...
const ConferenceCalendar: React.FC<ConferenceCalendarProps> = ({
  ...
  const [selectedConferenceForDialog, setSelectedConferenceForDialog] = useState<Conference | null>(null);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                  ...
                  {Array.from({ length: 42 }, (_, i) => {
                    ...
                    return (
                      ...
                      >
                        {isCurrentMonth && (
                          <>
                            <div className={`text-sm mb-1 font-medium ${isToday ? 'text-blue-600 font-bold' : 'text-gray-700'}`}>
                              {dayNum}
                            </div>
                            {dayEvents.length > 0 && (
                              <div className="space-y-1">
                                {dayEvents.slice(0, 2).map(event => (
                                  <div 
                                    ...
                                    style={{ 
                                      backgroundColor: getCategoryColor(event.conference.conferenceCategoryName, event.isSession) + '20',
                                      color: getCategoryColor(event.conference.conferenceCategoryName, event.isSession),
            ...
            >
              {conferences.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-lg font-medium mb-2">Chưa có hội nghị nào</p>
                      ...
                      {conf.conferenceCategoryName && (
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            ...
                            style={{
                              backgroundColor: getCategoryColor(conf.conferenceCategoryName) + '20',
      ...
      {sessionDialogOpen && selectedConferenceForDialog && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm" onClick={() => setSessionDialogOpen(false)} />
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {session.roomDisplayName && (
                        <div className="flex items-center gap-2 text-gray-700">
                          ...
                          <span className="text-xs">{session.roomDisplayName}</span>
