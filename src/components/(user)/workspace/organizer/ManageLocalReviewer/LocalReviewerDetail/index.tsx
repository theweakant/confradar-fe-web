...
interface LocalReviewerDetailProps {
  reviewer: UserProfileResponse;
  onClose: () => void;
}

export function LocalReviewerDetail({ reviewer, onClose }: LocalReviewerDetailProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">Tên phản biện nội bộ</p>
