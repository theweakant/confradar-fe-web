      ...
      <div className="max-w-7xl mx-auto">
        ...
        {waitListLoading && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 mt-4">Đang tải danh sách chờ...</p>
          </div>
        )}
        ...
        {waitListError && (
          <div className="text-center py-16">
            <div className="text-red-600 mb-4">
              ...
              <p className="text-gray-600">{waitListError.data?.message}</p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-6">
            {waitlistConferences.map((conference) => (
              <Card
                ...
                className="overflow-hidden hover:shadow-lg transition-shadow bg-white border-gray-200"
              >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                          ...
                          <Badge
                            variant="secondary"
                            className={`w-fit border ${getStatusColor(conference.waitListStatusName)}`}
                          >
