...
export function ExternalReviewerForm({ reviewer, onSave, onCancel }: ExternalReviewerFormProps) {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4">
        ...
        <FormInput
          ...
          placeholder="VD: externalreviewer@example.com"
        />
      ...
      <div className="flex justify-end gap-3 pt-4 border-t">
        ...
        >
          {reviewer ? "Cập nhật" : "Thêm Phản biện bên ngoài"}
        </Button>
      </div>
    </div>
  );
