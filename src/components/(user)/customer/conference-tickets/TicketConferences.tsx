      ...
      <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">{ticketsError.data?.message}</p>
            <Button
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {filteredTickets.map((ticket) => (
            <Card
              key={ticket.ticketId}
              className="bg-white border-gray-200 hover:shadow-lg hover:shadow-purple-500/10 transition-shadow overflow-hidden"
            >
              {/* Ticket Info */}
              ...
              <div className="flex flex-row lg:flex-row w-full">
                ...
                <CardContent className="p-0 flex flex-row w-full">
                  ...
                  <div className="p-4 space-y-3 basis-2/3">
                    ...
                    <div className="flex gap-4">
                      ...
                      {ticket.bannerImageUrl && (
                        <div className="flex-shrink-0 w-32 h-32 rounded-lg overflow-hidden border border-gray-300">
                          <img
                      ...
                      <div className="bg-gray-100 border border-gray-300 rounded-lg p-3">
                        <div className="flex items-center gap-2 text-sm text-gray-700">
                          ...
                          <div className="flex-1">
                            <div className="text-xs text-gray-600 mb-0.5">Thời gian bán vé</div>
                  ...
                  <div className="p-4 space-y-4 bg-gray-50 flex flex-col basis-1/3">
                    ...
                    <div className="flex-1">
                      {(() => {
                        ...
                        if (ticket.isRefunded) {
                          return (
                            <div className="bg-gray-100 border border-gray-300 rounded-lg p-4 h-full flex items-center justify-center">
                        ...
                        if (!ticket.hasRefundPolicy) {
                          return (
                            <div className="bg-gray-50 border border-gray-300 rounded-lg p-4 h-full flex items-center justify-center">
                              <div className="flex flex-col items-center gap-2 text-gray-600 text-center">
                                <X className="h-8 w-8" />
                        ...
                        return (
                          <div className="bg-blue-50 border border-blue-300 rounded-lg p-4 space-y-3 h-full flex flex-col">
                            {/* Header */}
                            ...
                            {refundInfo.canRefund && refundInfo.refundAmount !== undefined && (
                              <div className="bg-green-50 border border-green-300 rounded-lg p-3">
                                <div className="text-xs text-gray-600 mb-1">Số tiền hoàn lại hiện tại</div>
                            ...
                            <div className="flex-1 overflow-y-auto">
                              <div className="text-xs font-medium text-gray-600 mb-2">Timeline hoàn vé:</div>
                              <div className="space-y-2 relative">
                                {/* Vertical line */}
                                <div className="absolute left-[7px] top-2 bottom-2 w-[2px] bg-gray-300"></div>
                                ...
                                {allDeadlines.map((policy, index) => {
                                  ...
                                  return (
                                    <div key={policy.refundPolicyId} className="flex gap-3 relative">
                                      ...
                                      {/* Content */}
                                      <div className={`flex-1 pb-2 ${isActive ? 'text-gray-900' : 'text-gray-600'}`}>
                                        <div className="text-xs font-medium">
                                          Trước {formatDateTime(policy.refundDeadline)}
                                        </div>
                                        <div className={`text-sm font-semibold ${isActive ? 'text-green-600' : isPast ? 'text-gray-400' : 'text-gray-700'
                                          }`}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-white border-gray-300 hover:bg-gray-100 text-gray-700"
                      >
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-lg bg-white border border-gray-200 shadow-xl transition-all">
                  ...
                  <div className="px-6 py-4 max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                              ...
                              {selectedExpandTicket.transactions.map((transaction) => (
                                ...
                                >
                                  <div className="flex justify-between items-start mb-3">
                                    <div className="flex-1">
                                      <div className="text-xs text-gray-600 mb-1">Mã giao dịch</div>
                                      <div className="text-sm text-gray-900 font-mono">
                                        {transaction.transactionCode}
                                      </div>
                                    </div>
                                    <div className="text-right">
                                      <div className="text-xs text-gray-600 mb-1">Số tiền</div>
                                      <div className="text-base font-semibold text-green-600 whitespace-nowrap">
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              <Transition.Child
                ...
                leaveTo="opacity-0 scale-95"
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-lg bg-white border border-gray-200 shadow-xl transition-all">
                  <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                    <Dialog.Title className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                    ...
                    {selectedTransaction && (
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          ...
                          <div>
                            <div className="text-gray-600">Tiền tệ</div>
                            <div className="text-gray-900">
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              <Transition.Child
                ...
                leaveTo="opacity-0 scale-95"
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-lg bg-white border border-gray-200 shadow-xl transition-all">
                  <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                    <Dialog.Title className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {selectedCheckIn?.qrUrl && (
                        <button
                          ...
                          className="bg-gray-100 hover:bg-gray-200 text-gray-900 px-3 py-1 rounded-md text-sm transition-colors"
                        >
                          Xem QR
                        </button>
                      )}
                          ...
                          <div className="bg-white p-3 rounded border border-gray-200 space-y-2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                              {selectedCheckIn.conferenceSessionDetail
                                .conferenceName && (
                                  <div>
                                    <div className="text-gray-600">Hội nghị</div>
                                    <div className="text-gray-900">
                                      {
                                        selectedCheckIn.conferenceSessionDetail
                                          .conferenceName
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
              <Transition.Child
                ...
                leaveTo="opacity-0 scale-95"
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-white border border-gray-200 shadow-xl transition-all">
                  <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                    <Dialog.Title className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                  ...
                  <div className="px-6 py-6 flex justify-center">
                    {selectedCheckIn?.qrUrl ? (
                      ...
                      <p className="text-gray-600">Chưa có QR Code</p>
                    )}
                  </div>
                </Dialog.Panel>
              </Transition.Child>
