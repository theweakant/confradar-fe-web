      ...
      {(!cameraReady || isEditing) && (
        <>
          <div className="bg-white border border-gray-300 rounded-xl p-5 space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Tải lên tệp camera-ready (.pdf)</label>
              <input
                type="file"
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white disabled:bg-gray-300 disabled:cursor-not-allowed rounded-lg font-medium transition"
            >
              {submitLoading
                ? "Đang xử lý..."
                : isEditing
