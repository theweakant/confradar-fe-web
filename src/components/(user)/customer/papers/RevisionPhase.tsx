...
const RevisionPhase: React.FC<RevisionPhaseProps> = ({ paperId, revisionPaper }) => {
  ...
  const actions = [
    ...
    {
      name: "Theo dõi phản hồi reviewer",
      progress: "60%",
      status: "in-progress",
    },
    {
      name: "Cập nhật thông tin tác giả",
      progress: "100%",
      status: "completed",
    },
              ...
              {revisionPaper ? (
                <div className="space-y-2">
                  ...
                  <p className="text-gray-400">
                    ...
                    {revisionPaper.overallStatus || "Đang xử lý"}
                  </p>
                  <p className="text-gray-400">
                    <span className="font-medium text-white">
                      Số submissions:
                  ...
                  {revisionPaper.created && (
                    <p className="text-gray-400">
                      <span className="font-medium text-white">Ngày tạo:</span>{" "}
                      {new Date(revisionPaper.created).toLocaleDateString(
                        "vi-VN",
                      )}
                    </p>
                  )}
                  {revisionPaper.reviewedAt && (
                    <p className="text-gray-400">
                      ...
                      {new Date(revisionPaper.reviewedAt).toLocaleDateString(
                        "vi-VN",
                      )}
                    </p>
                  )}
