...
//         // 2. UPDATE existing tickets (có priceId)
...
//         // 3. CREATE new tickets (không có priceId)
...
//       // 3. CREATE new sessions (không có sessionId)
