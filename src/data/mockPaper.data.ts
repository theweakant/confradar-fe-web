...
export const mockPaperData: Paper[] = [
  {
    id: "P001",
    title:
      "Deep Learning Approaches for Natural Language Understanding in Vietnamese",
    authors: ["Nguyễn Văn A", "Trần Thị B", "Lê Văn C"],
    authorEmails: [
      "nguyenvana@uni.edu.vn",
      "tranthib@uni.edu.vn",
      "levanc@uni.edu.vn",
    ],
    abstract:
      "This paper presents a comprehensive study on applying deep learning techniques to Vietnamese natural language understanding tasks. We propose a novel transformer-based architecture that achieves state-of-the-art results on multiple benchmarks including sentiment analysis, named entity recognition, and question answering. Our experiments demonstrate significant improvements over existing methods with detailed ablation studies.",
    keywords: ["Deep Learning", "NLP", "Vietnamese", "Transformer", "BERT"],
    ...
    cameraReadyDeadline: "2024-12-20",
    coauthorSaleDeadline: "2024-11-30",
  },
  {
    id: "P002",
    title: "Federated Learning for Privacy-Preserving Healthcare Applications",
    ...
    authorEmails: ["phamthid@hospital.vn", "hoangvane@hospital.vn"],
    abstract:
      "We explore the application of federated learning techniques in healthcare settings where patient privacy is paramount. Our framework enables collaborative model training across multiple hospitals without sharing sensitive patient data. Results show competitive accuracy while maintaining strict privacy guarantees through differential privacy mechanisms.",
    keywords: [
      "Federated Learning",
      "Privacy",
      "Healthcare",
    ...
    decisionDate: "2024-09-28",
    decisionNotes:
      "Excellent work with strong experimental validation. Minor revisions suggested for camera-ready version.",

    // Deadlines
    currentRound: 2,
    reviewDeadline: "2024-10-30",
    cameraReadyDeadline: "2024-11-25",
    coauthorSaleDeadline: "2024-11-10",
  },
  {
    id: "P003",
    title:
      "Real-time Object Detection for Autonomous Driving in Urban Environments",
    authors: ["Đỗ Văn F", "Vũ Thị G", "Bùi Văn H"],
    authorEmails: ["dovanf@tech.vn", "vuthig@tech.vn", "buivanh@tech.vn"],
    abstract:
      "This short paper introduces an optimized object detection model for autonomous vehicles operating in complex urban settings. Our lightweight architecture achieves 45 FPS on embedded devices while maintaining high accuracy for detecting pedestrians, vehicles, and traffic signs.",
    keywords: [
      "Computer Vision",
      "Object Detection",
      "Autonomous Driving",
    ...
    // Deadlines
    currentRound: 1,
    reviewDeadline: "2024-11-01",
    cameraReadyDeadline: "2024-12-05",
    coauthorSaleDeadline: "2024-11-15",
  },
  {
    id: "P004",
    title: "Quantum Computing Algorithms for Optimization Problems",
    ...
    authorEmails: ["lythii@quantum.edu.vn"],
    abstract:
      "We present novel quantum algorithms for solving complex optimization problems with applications in logistics and supply chain management. Preliminary results on quantum simulators show promising speedups compared to classical approaches.",
    keywords: ["Quantum Computing", "Optimization", "Algorithms", "QAOA"],
    ...
    // Deadlines
    currentRound: 1,
    reviewDeadline: "2024-11-20",
    cameraReadyDeadline: "2024-12-30",
    coauthorSaleDeadline: "2024-12-01",
  },
  {
    id: "P005",
    title: "Blockchain-based Secure Voting System: A Case Study",
    ...
    authorEmails: ["truongvank@blockchain.vn", "ngothil@blockchain.vn"],
    abstract:
      "This poster presents our implementation of a blockchain-based voting system deployed in a local election. We discuss the architecture, security features, and user experience findings from real-world deployment.",
    keywords: ["Blockchain", "Security", "E-Voting", "Distributed Systems"],
    ...
    decisionDate: "2024-09-10",
    decisionNotes:
      "Good practical contribution. Accepted as poster presentation.",

    // Deadlines
    currentRound: 1,
    reviewDeadline: "2024-10-25",
    cameraReadyDeadline: "2024-11-20",
    coauthorSaleDeadline: "2024-11-05",
  },
  {
    id: "P006",
    title: "Adversarial Attacks on Medical Image Analysis Systems",
    ...
    abstract:
      "We investigate the vulnerability of deep learning models used in medical image analysis to adversarial attacks. Our study reveals critical security concerns and proposes robust defense mechanisms to ensure reliable clinical deployment.",
    keywords: [
    ...
    decisionDate: "2024-09-15",
    decisionNotes:
      "Insufficient novelty and limited experimental validation. Reviewers suggest major revisions and resubmission to future conferences.",

    // Deadlines (không còn relevent vì đã bị reject)
    currentRound: 1,
    reviewDeadline: "2024-09-05",
    cameraReadyDeadline: "2024-10-15",
    coauthorSaleDeadline: "2024-09-20",
  },
  {
    id: "P007",
    title: "Explainable AI for Credit Risk Assessment in Banking",
    ...
    authorEmails: ["lamthip@bank.vn", "dangvanq@bank.vn"],
    abstract:
      "We develop an explainable machine learning framework for credit risk assessment that provides transparent and interpretable predictions. Our approach combines gradient boosting with SHAP values to meet regulatory requirements while maintaining high predictive accuracy.",
    keywords: [
      "Explainable AI",
      "Credit Risk",
      "Banking",
    ...
    // Deadlines
    currentRound: 1,
    reviewDeadline: "2024-11-10",
    cameraReadyDeadline: "2024-12-15",
    coauthorSaleDeadline: "2024-11-25",
  },
  {
    id: "P008",
    title: "Graph Neural Networks for Social Network Analysis",
    ...
    authorEmails: ["caovanr@social.edu.vn"],
    abstract:
      "This workshop paper explores the application of graph neural networks to analyze social network dynamics. We present preliminary findings on community detection and influence propagation patterns.",
    keywords: [
    ...
    // Deadlines (không còn relevent vì đã withdraw)
    currentRound: 1,
    reviewDeadline: "2024-10-10",
    cameraReadyDeadline: "2024-11-15",
    coauthorSaleDeadline: "2024-10-25",
  },
];
...
export const mockReviewData: PaperReview[] = [
  {
    ...
    confidence: 4,
    comments:
      "This paper presents a solid contribution to Vietnamese NLP. The proposed architecture is well-motivated and the experimental results are convincing.",
    strengths:
      "- Novel approach for Vietnamese language\n- Comprehensive experiments\n- Clear presentation\n- State-of-the-art results",
    weaknesses:
      "- Limited comparison with recent multilingual models\n- Could benefit from more error analysis\n- Some implementation details are missing",
    recommendedAction: "minor_revision",
    reviewDate: "2024-09-25",
    status: "completed",
  },
  {
    ...
    confidence: 5,
    comments:
      "Good paper with interesting ideas. However, the novelty is somewhat limited as similar approaches have been explored for other languages.",
    strengths:
      "- Well-written paper\n- Good experimental setup\n- Useful contribution to Vietnamese NLP community",
    weaknesses:
      "- Limited novelty in the approach\n- Missing ablation studies on some components\n- Could include more recent baselines",
    recommendedAction: "minor_revision",
    reviewDate: "2024-09-27",
    status: "completed",
  },
  {
    ...
    confidence: 5,
    comments:
      "Excellent work on an important problem. The privacy-preserving aspects are well-designed and the experimental validation is thorough.",
    strengths:
      "- Addresses critical healthcare privacy concerns\n- Strong theoretical foundations\n- Comprehensive experiments\n- Clear practical impact",
    weaknesses:
      "- Could discuss scalability to larger networks\n- Minor presentation issues",
    recommendedAction: "accept",
    reviewDate: "2024-09-20",
    status: "completed",
  },
  {
    ...
    confidence: 4,
    comments:
      "Strong paper with good motivation and execution. The federated learning framework is well-suited for the healthcare domain.",
    strengths:
  ...
  },
  {
    ...
    confidence: 4,
    comments:
      "The paper tackles a relevant problem but needs significant improvements. The evaluation is limited and some design choices are not well justified.",
    strengths: "- Relevant application\n- Real-time performance considerations",
    weaknesses:
  ...
  },
  {
    ...
    confidence: 3,
    comments:
      "Decent work on autonomous driving. The paper would benefit from more extensive experiments and clearer presentation of the methodology.",
    strengths:
  ...
  },
  {
    ...
    confidence: 4,
    comments:
      "Interesting practical implementation. Good fit for poster presentation. Would like to see more technical details in the final version.",
    strengths:
      "- Real-world deployment\n- Addresses important security concerns\n- Good user study",
    weaknesses:
      "- Limited technical depth (appropriate for poster)\n- Could discuss scalability more",
    recommendedAction: "accept",
    reviewDate: "2024-09-05",
    status: "completed",
  },
  {
    ...
    confidence: 5,
    comments:
      "Strong paper that addresses an important problem in the banking sector. The explainability aspects are well-handled and meet regulatory requirements.",
    strengths:
      "- Addresses real business need\n- Strong explainability framework\n- Good balance of accuracy and interpretability\n- Well-written",
    weaknesses:
      "- Could include more diverse datasets\n- Discussion of limitations could be expanded",
    recommendedAction: "accept",
    reviewDate: "2024-10-02",
    status: "completed",
  },
