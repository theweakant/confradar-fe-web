...
export function ResearchConferenceStepForm({
  ...
  const {
    currentStep,
    conferenceId: reduxConferenceId,
    mode: reduxMode,
    maxStep,
  } = useAppSelector((state) => state.conferenceStep);
  ...
  const { data: rankingData, isLoading: isisRankingLoading } =
  ...
  const [revisionRoundDeadlines, setRevisionRoundDeadlines] = useState<
    RevisionRoundDeadline[]
  >([]);
  const [newRevisionRound, setNewRevisionRound] =
    useState<RevisionRoundDeadline>({
      endDate: "",
      roundNumber: 0,
    });
    ...
    if (isEditMode) {
      ...
      switch (currentStep) {
        case 1:
          ...
          break;
        case 2:
          handleResearchDetailSubmitCreate();
          break;
        case 3:
          handlePriceSubmitCreate();
          break;
        case 4:
          handleResearchPhaseSubmitCreate();
          break;
        case 5:
          handleSessionSubmitCreate();
          break;
        case 6:
          handlePoliciesSubmitCreate();
          break;
        case 7:
          handleMaterialsAndRankingsSubmitCreate();
          break;
        case 8:
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormInput
                ...
                onChange={(val) =>
                  setBasicForm({ ...basicForm, ticketSaleEnd: val })
                }
                required
              />
            </div>
            ...
            <div className="border p-4 rounded">
              ...
              <div className="mt-4 space-y-3 border-t pt-3">
                ...
                <FormInput
                  ...
                  onChange={(val) =>
                    setNewPhase({ ...newPhase, applyPercent: Number(val) })
                  }
                  required
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <FormInput
                    ...
                    onChange={(val) =>
                      setNewPhase({ ...newPhase, endDate: val })
                    }
                    required
                  />
                </div>
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded">
                ...
                <ul className="text-sm text-green-800 space-y-1">
                  ...
                  {tickets.length > 0 && (
                    <li>
                      ✓ Tổng slot vé:{" "}
                      {tickets.reduce((sum, t) => sum + t.totalSlot, 0)}
                    </li>
                  )}
                </ul>
              </div>
            ...
            <div className="border p-4 rounded">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormInput
                  ...
                  onChange={(val) =>
                    setResearchPhase({ ...researchPhase, reviewStartDate: val })
                  }
                />
                <FormInput
                  label="Ngày kết thúc"
                  ...
                  onChange={(val) =>
                    setResearchPhase({ ...researchPhase, reviewEndDate: val })
                  }
                />
              </div>
            </div>
            ...
            <div className="border p-4 rounded">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormInput
                  ...
                  onChange={(val) =>
                    setResearchPhase({ ...researchPhase, reviseStartDate: val })
                  }
                />
                <FormInput
                  label="Ngày kết thúc"
                  ...
                  onChange={(val) =>
                    setResearchPhase({ ...researchPhase, reviseEndDate: val })
                  }
                />
              </div>
              ...
              <div className="mt-4 border-t pt-3">
                ...
                {revisionRoundDeadlines.map((round, idx) => (
                  <div
                    key={idx}
                    className="p-2 bg-gray-50 rounded mb-2 flex justify-between items-center"
                  >
                    ...
                    <Button
                      ...
                      variant="destructive"
                      onClick={() =>
                        setRevisionRoundDeadlines(
                          revisionRoundDeadlines.filter((_, i) => i !== idx),
                        )
                      }
                    >
                      Xóa
                ...
                <div className="grid grid-cols-3 gap-2 mt-2">
                  ...
                  <FormInput
                    ...
                    onChange={(val) =>
                      setNewRevisionRound({ ...newRevisionRound, endDate: val })
                    }
                  />
              ...
              <div className="space-y-2">
                {refundPolicies.map((rp, idx) => (
                  ...
                  >
                    <div>
                      <div className="font-medium">
                        Hoàn {rp.percentRefund}%
                      </div>
                      <div className="text-sm text-gray-600">
                        Trước ngày: {rp.refundDeadline} | Thứ tự:{" "}
                        {rp.refundOrder}
                      </div>
                    </div>
                    <Button
            ...
            <div className="border p-4 rounded">
              ...
              <div className="mt-4 space-y-3 border-t pt-3">
                ...
                <FormInput
                  ...
                  onChange={(val) =>
                    setNewRankingReference({ referenceUrl: val })
                  }
                  placeholder="https://..."
                  required
                />
            ...
            {isEditMode && (
              <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>
                    ✓ Chính sách: {policies.length} điều khoản,{" "}
                    {refundPolicies.length} hoàn tiền
                  </li>
      ...
      {isEditMode && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800 font-medium">
            🔧 Chế độ chỉnh sửa - Thay đổi sẽ được lưu khi bạn nhấn &quot;Lưu
            tất cả thay đổi&quot; ở bước cuối
          </p>
        </div>
      )}
